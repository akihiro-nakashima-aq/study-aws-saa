...
const EXAM = {
  ...
  <table>
    ...
    <tr><td>②</td><td>日次（1日1回）</td><td>決まった時刻に自動で始めてくれる「目覚まし時計」が要る</td></tr>
  ...
  <p>ここが一番大事なポイントです。24時間ずっとサーバーを起動しておくのは、1日1回しか使わない教室のエアコンを24時間つけっぱなしにするのと同じ。お金も手間ももったいない。だから「必要なときだけ動いて、終わったら勝手に片づく」仕組みを選びます。</p>

  <h2>合図を出す役と、実行する役は別</h2>
  ...
  <p class="caption">EventBridgeとStep Functionsはどちらも「自分では処理しない」のが共通点。処理する場所（Lambda・Batch・EC2）と必ずセットで考えます。</p>
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>ハイパフォーマンスコンピューティング（HPC）</td><td>たくさんのコンピュータで手分けして、1つの大きな計算をする</td></tr>
    <tr><td>②</td><td>分散処理で迅速に処理</td><td><mark>手分けした者どうしが、すごい速さで連絡を取り合う必要がある</mark></td></tr>
    <tr><td>③</td><td>運用上のオーバーヘッド（運用の手間）を抑制</td><td>クラスターの組み立てや管理を、人間が手作業でやらない</td></tr>
  </table>
  ...
  <p>たとえるなら、隣の席の友だちに紙を渡すのに、いちいち職員室の先生を通すのがふつうの通信。EFAは<strong>隣の席に直接手渡し</strong>です。1回の差はわずかでも、この連絡が計算中に何億回も起きるので、全体では大きな差になります。</p>

  <h2>MPIは話し方、EFAはその通り道</h2>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②「すごい速さで連絡を取り合う」とヒント③「運用の手間を抑える」の両方を満たしません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②の「連絡を取り合いながら計算する」形そのものを作れません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">運用の手間はAよりマシでも、ヒント②の「すごい速さで連絡を取り合う」を満たしません。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>「HPC」「MPI」「ノード間の低レイテンシ」が出たら ParallelCluster ＋ EFA。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>AWS Lambda（サーバーレス）</td><td>呼ばれるたびに新しい実行環境が立ち上がる。同時にいくつも並んで動く</td></tr>
    <tr><td>②</td><td>多くのデータ処理を行う</td><td><mark>Lambdaが一度にたくさん起動し、そのぶんDBへの接続が一気に増える</mark></td></tr>
    <tr><td>③</td><td>接続構成を最適化／運用の手間を抑える</td><td>接続の使い回しを自前で作らず、任せられる仕組みを使う</td></tr>
  </table>
  ...
  <p>たとえるなら、100人の生徒が図書館に来るたびに、自分専用の机を新しく運び込むのが直接つなぐやり方。すぐ部屋がいっぱいになります。RDS Proxyは<strong>共有の机を貸し出す受付係</strong>。使い終わった人から机を返してもらい、次に来た人へ回します。机の数はずっと少なくて足ります。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②の「接続が一気に増える」問題を、まったく解決していません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">これはどこにつなぐかの話。何本つなぐかの話ではないので、席が足りなくなる問題は何も変わりません。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>「Lambda」と「RDS」が同じ問題文に出たら、答えはRDS Proxy。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:36%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>単一の論理ボリュームとして運用</td><td>ファイル共有でもテープでもなく、1本のディスクとして見えるものが必要</td></tr>
    <tr><td>②</td><td>ローカルストレージの制約を回避するためにS3に拡張</td><td>ここだけ読むと「S3を本体にする」ように見える。これがワナ</td></tr>
    <tr><td>③</td><td>ローカルをメインストレージ、S3をバックアップ</td><td><mark>データの本体はオンプレミスに置く。S3は控えのコピー置き場</mark></td></tr>
  </table>
  <p class="caption">3行目が最後に出てきて、2行目をひっくり返します。矛盾しているように見えたら、あとに書かれたほうが本当の要件です。</p>
  ...
  <p class="caption">矢印の向きに注目してください。保管型は下向き（ローカル→S3にコピーを送る）、キャッシュ型は上向き（S3から取り寄せる）。これがそのまま「どちらが本体か」を表しています。</p>

  <p>たとえるなら、保管型は教科書を全部自分の本棚に置いて、コピーを実家に送って預けておくやり方。いつでも手元からすぐ開けます。キャッシュ型は<strong>本体を図書館に預けて、手元にはよく読むページだけ置く</strong>やり方。手元にないページは、そのつど取り寄せることになります。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③の「ローカルをメインストレージにする」と本体の置き場所が逆です。問題文の前半だけを読むとこれを選んでしまいます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「単一の論理ボリュームとして運用する」を満たしません。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>Storage Gatewayのボリュームは、本体がローカルなら保管型、S3ならキャッシュ型。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:36%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>マイクロサービスに分割し、疎結合化</td><td>小さな部品に分けて、それぞれが独立して動くようにする</td></tr>
    <tr><td>②</td><td>マイクロサービスの構築にはコンテナを利用します</td><td>コンテナと名指しされている。関数（Lambda）ではない</td></tr>
    <tr><td>③</td><td>コンテナ用コンピュートリソースの構成管理を不要に</td><td><mark>コンテナを動かすサーバーを、自分で用意も管理もしない</mark></td></tr>
  </table>
  <p class="caption">3行目の「コンピュートリソース」とは、コンテナが動く土台のサーバーのことです。その構成管理が要らない＝台数もOSも自分では触らない、という意味になります。</p>
  ...
  <p>たとえるなら、EC2起動タイプは工場を自分で建てて、その中で作業するやり方。建物の掃除も電気も耐震工事も自分持ちです。Fargateは<strong>貸し作業スペースを時間で借りる</strong>やり方。建物の面倒は大家さんが見てくれるので、こちらは作業そのものに集中できます。</p>

  <h2>ECS・EKSは「どこで動かすか」を決めていない</h2>
  ...
  <p class="caption">いちばんの誤解は「Fargateは独立したサービス」と思ってしまうこと。実際はECSやEKSに対して「場所はおまかせで」と指定する起動タイプです。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③の「構成管理を不要に」に反します。自動化しただけで、管理する対象は残ったままです。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②で「コンテナを利用します」と名指しされています。コンテナと書かれた時点でこの選択肢は消えます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Aと同じくヒント③を満たしません。EC2という言葉が出てきた時点で、土台の管理は自分に残ります。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p>コンテナで作り（ヒント②）、サービスごとに独立して動かせて（ヒント①）、土台のサーバーはAWSが持つ（ヒント③）。指定するのは「このコンテナにCPUいくつ、メモリいくつ」だけです。</p>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>「コンテナ」＋「サーバーを管理したくない」＝ ECS／EKS の Fargate 起動タイプ。</strong></p>
  </div>`
  },

  {
    ...
    explain: `
  <h2>まず、問題文の中の「3つのヒント」</h2>
  <p>選択肢はどれも「暗号化する」で終わっています。違うのは<strong>いつ・どうやって</strong>だけ。つまりこの問題は、暗号化のやり方ではなく設定を変えられるタイミングを聞いています。</p>
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:36%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>DAXクラスターを追加した</td><td>クラスターはすでに作られて動いている</td></tr>
    <tr><td>②</td><td>保管データを暗号化する必要がある</td><td>ディスクに置かれたデータを読めなくする設定が要る</td></tr>
    <tr><td>③</td><td>現在は実施できていない</td><td><mark>暗号化なしで作ってしまった。あとから有効にできるかどうかが分かれ目</mark></td></tr>
  </table>

  <h2>決め手は「暗号化を決められるのは作成時だけ」</h2>
  <p>DAX（ダックス）はDynamoDBの前に置く<strong>おぼえのいい受付係</strong>です。一度聞かれた答えを手元に覚えておいて、次に同じ質問が来たら即答します。そのDAXの保管時の暗号化は、クラスターを作るときにしか決められません。あとから「やっぱり暗号化する」に切り替えるボタンは存在しません。</p>
  ...
  <p>たとえるなら、<strong>金庫つきの部屋を借りるようなもの</strong>です。金庫を入れるかどうかは契約するときに決めます。入居してから「やっぱり金庫を入れたい」と言っても、壁を壊さずに後付けはできません。引っ越すしかない、というのがDAXの暗号化です。</p>
  ...
  <p class="caption">作り直してもデータは失われません。DAXが持っているのはDynamoDBのコピーだからです。ここが「作り直し」を選びやすい理由でもあります。</p>
  ...
  <p class="caption">S3だけ感覚が違うので注意。「箱を作るときに決める」タイプが多数派と覚えておくと迷いません。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">DAXの暗号化は停止しても編集できません。ヒント③の「あとから有効にできるか」に対して、できないのが答えです。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">鍵の準備は問題の本質ではありません。ヒント③の「作成済みかどうか」を見落とした選択肢です。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　DAXクラスターを作成し直して、暗号化を有効化する</strong></p>
    <p class="oboe">覚え方 —— <strong>「既存を暗号化したい」と来たら、DAX・RDS・EBS・EFSは作成時のみなので作り直すかコピーの2択。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:40%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>インターネットから直接にデータベースサーバーに接続されないようにする</td><td>外から入ってこられない場所に置く → プライベートサブネット</td></tr>
    <tr><td>②</td><td>必要なパッチをダウンロードする場合を除き</td><td><mark>外に出る通信だけは必要。入る通信は要らない</mark> → 片道だけ通す仕組み</td></tr>
  </table>
  <p class="caption">「〜する場合を除き」という書き方に注意します。これは例外を1つだけ認めているという意味で、そこが正解を分けます。</p>
  ...
  <p class="caption">矢印に注目してください。IGWは両向き（↕）、NATゲートウェイは片道（↓）。この違いだけで答えが決まります。</p>

  <p>たとえるなら、NATゲートウェイは「代わりに買い物に行ってくれる人」です。データベースは店に出かけません。必要なものをNATに頼み、NATが買って持ち帰ります。店から見えるのはNATだけなので、<strong>店員はデータベースの住所を知りません</strong>。一方インターネットゲートウェイは表玄関を開けっぱなしにするようなもので、こちらから出られる代わりに、誰でも訪ねてこられます。</p>
  ...
  <p class="caption">つまり「プライベートサブネットにIGWへのルートを引く」と書いた瞬間、それはもうプライベートサブネットではありません。言葉として矛盾しています。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「インターネットから直接接続されないようにする」を真正面から破っています。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の置き場所が違います。DBは奥の部屋に置かなければいけません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">名前だけプライベートで中身はパブリックになり、ヒント①を満たしません。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>「外から入れたくない、でも外には出たい」＝ プライベートサブネット ＋ NATゲートウェイ。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:36%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>クリックストリームデータ</td><td><mark>ユーザーがクリックするたびに発生する。止まらずに流れ続けるデータ</mark></td></tr>
    <tr><td>②</td><td>毎日1TBを超える</td><td>とても多い。全部をデータベースに取り込むのは重すぎる</td></tr>
    <tr><td>③</td><td>保存して、効果的に分析する</td><td>置き場所（保存）と分析する道具の両方が要る</td></tr>
  </table>
  <p class="caption">クリックストリームとは、ユーザーがサイトの中でどこをクリックしたかの記録です。人が操作するたびに1件ずつ生まれるので、水道のように流れ続けます。</p>
  ...
  <p class="caption">クリックストリームは蛇口から出続ける水です。Data Pipelineはバケツを1日1回汲みに行く人、Kinesisは蛇口にホースをつなぐやり方。流れ続けるものには、ホースをつなぐほうが合っています。</p>

  <p>もうひとつのたとえです。Data Pipelineは学校の給食の配膳で、決まった時間にまとめて運びます。Kinesisは<strong>ベルトコンベア</strong>で、乗ったものが次々に流れていきます。今回は「毎日1TBが休みなく発生する」ので、ベルトコンベアの出番です。</p>
  ...
  <p class="caption">Redshift SpectrumはS3に置いたデータを、取り込まずにそのままSQLで分析できます。1TBを毎日どこかに引っ越しさせる必要がありません。</p>

  <h2>受け止める・届ける・分析するは、別々のサービス</h2>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「流れ続けるデータ」に集め方が合いません。分析側も手間が大きい選び方です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Aと同じくヒント①に反します。半分だけ正しい選択肢で、いちばん迷わせてきます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③の「効果的に分析する」を満たしません。1TB全体を横断して集計することができません。</p>
    </div>
  </div>
  ...
  <p class="caption">4択が2×2の表になっていることに気づけば、半分ずつ正しい選択肢のワナにかかりません。</p>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>止まらず流れ続けるデータはKinesis、「決まった時刻に1日1回」ならバッチ。</strong></p>
  </div>`
  },

  {
    ...
    explain: `
  <h2>まず、問題文の中の「2つのヒント」</h2>
  <p>選択肢はRoute 53が2つ、ロードバランサーが2つ。まず<strong>道具の種類</strong>を決めて、次にRoute 53の中のどの方式かを決める、という2段階で解きます。</p>
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:36%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>3つのリージョンに複製し、ルーティング制御</td><td>リージョンをまたいで振り分ける必要がある → ロードバランサーの守備範囲外</td></tr>
    <tr><td>②</td><td>最適な言語選択</td><td><mark>言語は「どの国から来たか」で決まる。「どこから近いか」では決まらない</mark></td></tr>
  </table>
  <p class="caption">「地理的に近いユーザーに対する」という前置きがあるので、つい「近さ」で選びたくなります。でも実際に求められているのは言語の出し分けです。</p>
  ...
  <p class="caption">どちらも「ユーザーのいる場所」を見ますが、見たあとの分け方が違います。位置情報は国名で、地理的近接性は距離で分けます。</p>

  <p>たとえるなら、位置情報ルーティングは「パスポートを見て案内する係」です。日本のパスポートなら日本語の窓口へ、と迷いません。地理的近接性は<strong>「いま立っている場所から一番近い窓口を教える係」</strong>。近い窓口には案内できますが、その人が何語を話すかは分かりません。今回ほしいのはパスポートを見る係のほうです。</p>
  ...
  <table>
    ...
    <tr><td class="good">位置情報</td><td class="good">ユーザーの国・地域</td><td class="good">言語を出し分けたい／国ごとに違う内容／法律で国を分ける</td></tr>
    <tr><td>地理的近接性</td><td>ユーザーとリソースの距離</td><td class="bad">特定の拠点に寄せる割合を調整したい（バイアス）</td></tr>
    <tr><td>レイテンシー</td><td>実際の応答の速さ</td><td class="bad">とにかく速く表示したい</td></tr>
    <tr><td>加重（Weighted）</td><td>あらかじめ決めた割合</td><td class="bad">新バージョンに10％だけ流したい</td></tr>
    <tr><td>フェイルオーバー</td><td>正常かどうかの健康チェック</td><td class="bad">普段はA、壊れたらBに切り替えたい</td></tr>
  </table>
  <p class="caption">まぎらわしいのは「近さ」で選ぶものが3つあること。位置情報＝国、地理的近接性＝距離、レイテンシー＝速さ。言語と来たら国です。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①のリージョンまたぎの振り分けと、ヒント②の言語判定を同時に満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①のリージョンまたぎに対応できません。道具の選択そのものが違います。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②の「言語」を決められません。いちばん惜しい選択肢で、ここで迷うと落とします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Bと同じくヒント①を満たしません。中身を見られるかどうか以前に、届く範囲が足りません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A　Route53において位置情報ルーティングを設定して、ユーザーの位置情報に応じた言語表示を自動で実施する</strong></p>
    <p class="oboe">覚え方 —— <strong>リージョンをまたぐ振り分けはRoute 53、ロードバランサーはリージョンの中だけ。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>パブリックアクセスブロックを有効にしている</td><td>バケットは閉じたまま。公開設定にはできない</td></tr>
    <tr><td>②</td><td>AWS外部のユーザー</td><td>AWSのアカウントを持っていない人。IAMの権限は渡せない</td></tr>
    <tr><td>③</td><td>特定のユーザーに一時的に表示</td><td><mark>渡した相手だけ、決めた時間だけ開ける仕組みが要る</mark></td></tr>
  </table>
  <p class="caption">「パブリックドメインの画像」とあるので公開してよさそうに見えますが、バケットは閉じたまま運用すると明記されています。ここを読み違えないようにします。</p>
  ...
  <p class="caption">バケットの設定は何も変えません。扉は閉じたまま、券を持っている人だけを通します。</p>
  ...
  <div class="day">
    ...
    <p class="caption">赤いところだけURLが使えます。時間が過ぎると、同じURLを開いてもエラーになります。こちらから取り消し作業をしなくても、勝手に無効になるのが利点です。</p>
  </div>

  <p>たとえるなら、事前署名付きURLは「時間の書かれた入場券」です。受付（アプリ）が本人を確かめて「18時まで有効」の券を渡します。券を持っている人だけが入れて、時間が過ぎれば自動で無効。<strong>建物の入口をずっと開け放つ必要はありません。</strong></p>

  <h2>AWSの外の人にそのまま渡せるのは、事前署名付きURLだけ</h2>
  ...
  <p class="caption">押さえどころは「暗号化」と「アクセス許可」は別物だということ。暗号化は中身を読めなくするだけで、誰が取りに来られるかは変えません。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③の「特定の相手に一時的に」を実現する手段が書かれていません。仕組みを足さないと成立しない選択肢です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①のとおりバケットは閉じているので、そもそも取りに来られません。さらに鍵を配る運用は、一時的な公開にはまったく向きません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②の「AWS外部のユーザー」に届きません。保存先を変える話で、要件そのものと噛み合っていません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A　Amazon S3の期限付きの事前署名付きURLを利用して、画像コンテンツをユーザーに配信する</strong></p>
    <p class="oboe">覚え方 —— <strong>「AWSの外の人に」「一時的に」「特定のファイルだけ」の3つがそろったら事前署名付きURL。</strong></p>
  </div>`
  },

  {
    ...
    explain: `
  <h2>まず、問題文の中の「3つのヒント」</h2>
  <p>「環境を作る」と聞くと選択肢がどれも正しそうに見えます。問題文をよく見ると、<strong>作るものの範囲</strong>と消すことが指定されています。</p>
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>AWS環境のインフラ構成を一括にデプロイ</td><td>サーバー1台ではなく、ネットワークもDBも含めたまるごと一式</td></tr>
    <tr><td>②</td><td>迅速にプロビジョニング</td><td>手作業で1つずつポチポチ作らない</td></tr>
    <tr><td>③</td><td>容易に削除できるようにする</td><td><mark>作るだけでなく、まとめて消せることが条件。ここが選択肢を分ける</mark></td></tr>
  </table>
  <p class="caption">開発・テスト環境は作っては壊すものです。だから「消しやすさ」が要件に入っています。消し忘れたリソースは料金だけがかかり続けます。</p>
  ...
  <p class="caption">ポイントは「スタック」というひとかたまりで管理されること。作るのも消すのも、この単位で一発です。</p>

  <p>たとえるなら、CloudFormationはプラモデルの設計図と組立キットです。同じ設計図があれば、何個でもまったく同じものが組み上がります。しかも箱ごと片づけられるので、部品が机に残ることもありません。手作業で1つずつ作るのは、設計図なしで毎回ちがう部品を探して組むようなものです。</p>

  <h2>まとめて作ってまとめて消せるのはCloudFormationだけ</h2>
  ...
  <p class="caption">AMIとECRはどちらも「1つの部品の型」です。今回ほしいのは組み立て全体の設計図なので、役者の大きさが足りません。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「インフラ構成を一括にデプロイ」を担当できません。役割が違います。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③の「容易に削除」を満たせません。動きはしますが、手間が残ります。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「インフラ構成を一括にデプロイ」に対して、そもそも作る機能を持っていません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　CloudFormationによりテスト環境用のテンプレートを作成する。このテンプレートを利用してテスト環境をデプロイできるようにする</strong></p>
    <p class="oboe">覚え方 —— <strong>「まとめて作って、まとめて消す」と書いてあればCloudFormation。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:42%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>サーバーのOS設定を自社で管理する</td><td><mark>OSにログインして設定を変えられる必要がある</mark></td></tr>
  </table>
  <p class="caption">OSとは、サーバーを動かしている基本ソフト（LinuxやWindows）のことです。「自社で管理する」とは、そこに入って自分で設定をいじるという意味になります。</p>

  <h2>決め手は「OSに入れるかどうか」</h2>
  <p>AWSのデータベースには2つの流儀があります。<strong>AWSが土台ごと面倒を見てくれる（マネージド）</strong>か、サーバーを1台借りて自分で全部やるかです。</p>
  ...
  <p class="caption">灰色の箱は「AWSのものなので手が出せない」という意味です。マネージドなDBが便利なのは、この部分をAWSが引き受けているからです。</p>

  <p>たとえるなら、RDSやAuroraは家具付きのマンションです。エアコンも冷蔵庫も最初から付いていて、壊れたら大家さんが直してくれます。その代わり<strong>壁に穴を開けることはできません</strong>。EC2は土地を借りて自分で家を建てるやり方。何でも好きにできますが、雨漏りの修理も自分でやります。</p>

  <h3>この問題は「良し悪し」を聞いていない</h3>
  <p>ふつうの設計では、運用の手間が小さいRDSやAuroraを選ぶのが定石です。ところがこの問題は<strong>「OSを自社で管理したい」と条件が指定されています</strong>。条件が先にある以上、便利かどうかではなく条件を満たせるかどうかで選びます。</p>

  <h2>OSに入れるのは、EC2に自分で建てたときだけ</h2>
  <table>
  ...
  <p class="caption">AuroraはRDSの仲間なので、RDSがだめならAuroraもだめです。選択肢に両方あるときは、まとめて判断できます。</p>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>「OSを管理したい」「特定のDB製品・バージョン」と書いてあるときだけ、EC2に自分で立てる。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>キュー内のメッセージは重複しない</td><td>入れる側は正しい。原因は取り出したあとにある</td></tr>
    <tr><td>②</td><td>複数のEC2インスタンスが処理する</td><td>同じメッセージを別のインスタンスが取る余地がある</td></tr>
    <tr><td>③</td><td>DBには時折重複レコード</td><td><mark>同じメッセージが2回処理されている</mark></td></tr>
  </table>
  <p class="caption">「メッセージは重複していないのに結果は重複する」。この食い違いが問題の中心です。1件のメッセージが2回処理されていると考えるしかありません。</p>

  <h2>決め手は「貸出中の札が早く外れている」こと</h2>
  <p>SQS（キュー）は仕事の順番待ちの行列です。インスタンスがメッセージを取り出すと、そのメッセージはしばらく<strong>他の人から見えなくなります</strong>。この見えない時間を可視性タイムアウトと呼びます。処理が終わってメッセージを削除すれば、そこで完了です。</p>
  <p>ところが処理が終わる前に可視性タイムアウトが切れると、メッセージがまた見えるようになります。すると別のインスタンスがそれを拾い、同じ仕事をもう一度やってしまいます。</p>
  ...
  <p class="caption">タイムアウトのほうが短いと、処理の途中でメッセージが行列に戻ります。これが重複の正体です。</p>
  ...
  <p class="caption">直し方は可視性タイムアウトを処理時間より長くすること。それだけで重複は止まります。</p>

  <p>たとえるなら、可視性タイムアウトは図書館の「貸出中」の札です。本を借りると札が立ち、他の人は借りられません。ところが<strong>まだ読んでいる途中で札が勝手に外れる</strong>と、別の人が同じ本を持っていってしまいます。札の有効期間を、読み終わるまでの時間より長くしておけば解決します。</p>

  <h2>重複の原因は、見えなくする時間の設定</h2>
  ...
  <p class="caption">よく混同するのが「可視性タイムアウト」と「ロングポーリングの待機時間」です。前者は取り出したあとの話、後者は取り出す前の話。時間軸が逆だと覚えます。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③の「同じメッセージが2回処理される」原因に、直接手を打っています。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">調整しているのは取り出す前の待ち時間です。重複が起きるのは取り出したあとなので、ここをいじっても直りません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A　ChangeMessageVisibility をAPI使用して、適切な可視性タイムアウト値を設定する</strong></p>
    <p class="oboe">覚え方 —— <strong>SQSで同じメッセージが2回処理されたら、原因は可視性タイムアウトが処理時間より短いこと。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>毎日17時から17時半</td><td><mark>いつ混むかが分かっている。予測できる</mark></td></tr>
    <tr><td>②</td><td>負荷増加が短時間</td><td>気づいてから増やしていては終わってしまう</td></tr>
    <tr><td>③</td><td>インスタンスの追加が間に合っていない</td><td>台数が足りないのではなく、増え始めるのが遅い</td></tr>
  </table>
  <p class="caption">「足りない」と「間に合わない」はまったく別の問題です。間に合わないのは時間の問題なので、数を増やしても解決しません。</p>
  ...
  <p class="caption">左右で変えたのは増やし始める時刻だけです。台数もインスタンスの種類も変えていません。</p>
  ...
  <div class="day">
    ...
    <div class="scale"><span>0時</span><span>6時</span><span>12時</span><span>18時</span><span>24時</span></div>
    <p class="caption">赤いところが混雑する時間帯。場所が毎日決まっているので、その直前に増やしておけば済みます。</p>
  </div>

  <p>たとえるなら、今のやり方は「行列ができてから店員を呼びに行く」状態です。呼ばれた店員が着替えて売り場に出るころには、お客さんは帰っています。スケジュールされたスケーリングは<strong>「ランチが混むと分かっているから11時半に店員を増やしておく」</strong>やり方です。</p>
  ...
  <table>
    ...
    <tr><td>動的スケーリング<br>（ターゲット追跡・ステップ）</td><td>CPU使用率などの実際の数値</td><td class="bad">いつ来るか分からない負荷。ただし気づくまでに時間がかかる</td></tr>
    <tr><td class="good">スケジュールされた<br>スケーリング</td><td class="good">時刻</td><td class="good">毎日／毎週／毎月、決まった時間に混む</td></tr>
    <tr><td>予測スケーリング</td><td>過去の実績からの予想</td><td class="bad">周期はあるが時刻がはっきり決まっていない</td></tr>
    <tr><td>最大数の変更</td><td>（増やし方ではない）</td><td class="bad">天井を上げるだけ。増え始める速さは変わらない</td></tr>
  </table>
  <p class="caption">押さえどころは「最大数」は上限であって、スピードではないということ。ここを取り違えると選択肢Aを選んでしまいます。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③は「足りない」ではなく「間に合っていない」です。数の問題ではなく時間の問題なので、効きません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">足りないのは配分ではなくサーバーの数です。ヒント③の原因に対して効き目がありません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「毎日決まった時刻」という条件をそのまま利用して、ヒント③の「間に合わない」を解消します。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：D　Auto Scalingに対して、スケジュールされたスケーリングポリシーを追加する</strong></p>
    <p class="oboe">覚え方 —— <strong>「毎日」「毎週」「決まった時刻に」混むと書いてあれば、スケジュールされたスケーリング。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>データセンター障害に備える</td><td><mark>建物1つの障害。AWSでいうアベイラビリティゾーン（AZ）1つ分</mark></td></tr>
    <tr><td>②</td><td>数分以内に再稼働</td><td>バックアップから戻していては間に合わない。待機役が動いている必要がある</td></tr>
    <tr><td>③</td><td>コスト効率の良い</td><td>要件を満たす中でいちばん安いものを選ぶ</td></tr>
  </table>
  <p class="caption">「データセンター障害」を「リージョン全体の災害」と読み違えると、選択肢AやBに行きます。データセンター1つ＝AZ1つです。</p>
  ...
  <p class="caption">1つのリージョンには、離れた場所にあるAZが複数あります。片方が停電しても、もう片方は生きています。</p>
  ...
  <p class="caption">AZ-aのデータセンターが落ちても、AZ-cのレプリカが自動でプライマリに切り替わります。切り替えはふつう30秒ほどで終わるので、「数分以内」を余裕で満たします。</p>
  ...
  <p class="caption">どちらも数分以内に復旧できます。違うのは備える範囲と値段だけ。だから「コスト効率」の一言で答えが決まります。</p>

  <p>たとえるなら、AZをまたぐ構成は「近所のもう1棟にも同じ設備を置く」やり方です。1棟が停電しても、もう1棟で続けられます。Global Databaseは<strong>海外に支社をもう1つ作る</strong>ようなもの。街ごと被災したときには頼れますが、「近所の建物が停電した」だけの話に海外支社を建てるのは、明らかにやりすぎです。</p>

  <h2>可用性の値段は、常に動かす台数で決まる</h2>
  <table>
  ...
  <p class="caption">選ぶ順番は①要件（守る範囲と速さ）を満たすか → ②その中でいちばん安いか。この順でしか判断できません。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">要件は満たしますが、備える範囲が大きすぎます。ヒント③の「コスト効率」で落ちます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Aと同じ理由です。Global Databaseと書かれた時点で、リージョンをまたぐ構成＝割高と判断できます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②の「数分以内に再稼働」を満たせません。備えとしては必要ですが、この要件の答えにはなりません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：C　Aurora DBクラスターのレプリカを複数アベイラビリティゾーンに展開する。プライマリDBに障害が発生した場合は、レプリカの１つをプライマリDBに昇格させる</strong></p>
    <p class="oboe">覚え方 —— <strong>「データセンター障害」なら複数AZで足り、Global Databaseは「リージョン全体」と書いてあるときだけ。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:40%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>Lambda関数がDynamoDBを操作する</td><td><mark>権限を受け取るのは人ではなく、AWSのサービス</mark></td></tr>
    <tr><td>②</td><td>Lambda関数に設定する</td><td>Lambda側に付けるもの。DynamoDB側の設定ではない</td></tr>
  </table>

  <h2>決め手は「人か、サービスか」</h2>
  <p>IAM（アイアム）はAWSの<strong>身分証と許可証を管理する仕組み</strong>です。ここでいちばん大事な区別は、権限を持つのが人なのかサービスなのかです。</p>
  ...
  <p class="caption">ロールを使うとコードの中に鍵を一切書かずに済みます。これが「サービスにはロール」と決まっている一番の理由です。</p>

  <p>たとえるなら、IAMユーザーは自分専用の社員証です。持ち主が決まっていて、貸し借りは禁止。落とすと大問題になります。<strong>IAMロールは受付で借りる来客用の入館証</strong>です。誰が使うかは決まっておらず、その場で借りて、用が済んだら返します。今回の「Lambda関数」は社員ではないので、入館証を借りるほうが自然です。</p>

  <h2>サービスに権限を渡すのはIAMロール</h2>
  ...
  <p class="caption">ポリシーは紙、ユーザーとロールはそれを持つ人。紙だけ用意しても、誰かが持たないと意味がありません。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「権限を受け取るのはサービス」に合いません。AWSが明確に避けるべきとしているやり方です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ほしいのは「Lambdaが他のサービスを操作する」権限です。呼ばれる側の設定では、呼びに行く権限になりません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　Lambda関数に適切な権限を付与したIAMロールを設定してDynamoDBへのアクセスを許可する</strong></p>
    <p class="oboe">覚え方 —— <strong>主語がAWSサービスなら権限はIAMロール、人ならIAMユーザー。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>静的ウェブサイト</td><td>中身が変わらないファイル。S3に置けば動く</td></tr>
    <tr><td>②</td><td>世界中のユーザー／迅速に</td><td><mark>遠くのユーザーにも速く届ける仕組みが要る</mark></td></tr>
    <tr><td>③</td><td>コスト効率の良い</td><td>同じ結果なら、置き場所は増やさないほうがよい</td></tr>
  </table>
  ...
  <p class="caption">CloudFrontは世界中に置かれた中継所（エッジロケーション）にコピーを預けておく仕組みです。ユーザーは自分にいちばん近い中継所から受け取ります。</p>
  ...
  <p class="caption">オリジンへ取りに行くのは最初の1回だけ。以降は中継所のコピーが使われるので、S3への通信料も減ります。</p>

  <p>たとえるなら、CloudFrontは全国のコンビニに人気商品を置いておくやり方です。倉庫は1つのままで、お客さんは近所の店で買えます。一方リージョンごとの複製は<strong>各地に倉庫そのものを建てる</strong>やり方。速くはなりますが、家賃も在庫管理も地域の数だけ増えます。</p>

  <h2>置き場所を増やさずに近づけるのはCloudFront</h2>
  ...
  <p class="caption">押さえどころはRoute 53は電話帳であって、配送業者ではないということ。宛先を教えても、距離は縮まりません。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②は満たしますが、ヒント③の「コスト効率」で落ちます。しかも宛先を振り分ける仕組みがないので、ユーザーがどこにつなぐかを決められません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">速さ（ヒント②）と安さ（ヒント③）を同時に満たします。静的サイトの定番の形です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">案内先が増えていないので、ヒント②の「速く届ける」が実現しません。振り分ける先がそもそもありません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">動くけれどバケットの数だけ料金と管理が増えます。CloudFrontなら同じことがバケット1つで実現できるので、ヒント③で負けます。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>「静的コンテンツを世界中に速く」と来たら S3 ＋ CloudFront（置き場所は1つのまま）。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>12時間以内に処理が完了</td><td><mark>すぐ処理しなくてよい。いったん溜めておける仕組みが向いている</mark></td></tr>
    <tr><td>②</td><td>注文を分類して管理</td><td>種類ごとに行き先を分ける必要がある</td></tr>
    <tr><td>③</td><td>費用対効果と運用効率</td><td>作り込みが少なく、種類が増えても手直しの小さい形</td></tr>
  </table>
  <p class="caption">「12時間以内」は非常にゆるい条件です。リアルタイム処理は求められていないという意味なので、ここで選択肢がふるいにかけられます。</p>

  <h2>決め手は「1回の放送を、種類ごとの受け箱に仕分ける」</h2>
  <p>登場するのは2つのサービスです。<strong>SNS（エスエヌエス）は放送</strong>で、1回しゃべると聞いている全員に届きます。SQS（エスキューエス）はレジの順番待ちの行列で、並んだ仕事は誰かが呼び出すまで消えません。</p>
  <p>この2つを組み合わせると、<strong>1件の注文を、種類に応じた受け箱に自動で仕分けられます</strong>。しかもSNSにはフィルターという機能があり、「これは書籍の注文」といった目印を見て、該当する受け箱にだけ届けることができます。</p>
  ...
  <p class="caption">この形をファンアウトと呼びます。入口は1つ、出口は種類の数だけ。注文の種類が増えても、入口はそのままでキューを1本足すだけです。</p>

  <p>たとえるなら、SNSは放送、SQSはレジの順番待ちの行列です。放送は1回流すだけ。ただし「これは書籍の注文」という目印を付けておけば、書籍担当の行列にだけ並びます。<strong>放送を聞き逃しても、行列に並んだままなので消えません</strong>。これがSQSを挟む理由です。</p>

  <h3>なぜSQSを挟むのか</h3>
  <p>SNSだけだと、放送は<strong>流した瞬間に聞いていた人にしか届きません</strong>。サーバーが再起動中だったら、その注文は消えます。SQSを挟めば、処理されるまでメッセージが残り続けます。12時間以内でよいのだから、溜めておけることのほうが価値があります。</p>

  <h2>SNSは配るだけ、ためられるのはSQS</h2>
  <table>
  ...
  <p class="caption">見分け方は「すぐ処理する必要があるか」。秒単位・リアルタイム・順番が大事 → Kinesis。数時間以内でよい・仕事の受け渡し → SQS。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①のとおり12時間以内でよいので、リアルタイム向けのKinesisは過剰です。ヒント③の「運用効率」も、シャード管理のぶん悪くなります。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③の「運用効率」に反します。正解はトピック1つで済むのに、こちらは種類の数だけ増えていきます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">溜められる（ヒント①）、種類で分けられる（ヒント②）、増えても手直しが小さい（ヒント③）。3つを同時に満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Aと同じくリアルタイム向けの道具で、しかもアプリ側の作り込みがいちばん多い選択肢です。ヒント③から最も遠くなります。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：C　Amazon SNSトピックを１つ作成して、このSNSトピックに複数のAmazon SQSキューをサブスクライブする（フィルターで振り分ける）</strong></p>
    <p class="oboe">覚え方 —— <strong>「1つの出来事を複数の宛先へ」＝ SNS ＋ SQS のファンアウト。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>オンプレミスのサーバーから使う</td><td>社内の機械とAWSをつなぐ中継役が要る</td></tr>
    <tr><td>②</td><td>iSCSIデバイスを介して接続</td><td>1本のディスクとして見せる方式。ファイル共有でもテープでもない</td></tr>
    <tr><td>③</td><td>AWS上のストレージをプライマリーに</td><td><mark>データの本体はAWS側。ローカルには置ききらない</mark></td></tr>
  </table>
  <p class="caption">iSCSI（アイスカジー）とは、ネットワーク越しのストレージをパソコンに直接つないだディスクのように見せる約束ごとです。「iSCSI」と書いてあれば、ブロックストレージの話だと決まります。</p>
  ...
  <p class="caption">サーバーから見れば、つながっているのはふつうのディスク1本です。その裏でAWSにデータが置かれていることを、アプリは知りません。</p>

  <p>たとえるなら、Storage Gatewayは社内と倉庫をつなぐ受付カウンターです。社員は「棚から取ってきて」と頼むだけ。実際の荷物が社内にあるのか遠くの倉庫にあるのかを、社員は意識しません。</p>
  ...
  <p class="caption">選択肢では起動タイプまで問われていませんが、「AWSをプライマリーストレージに」＝キャッシュ型ボリュームだと読めるようにしておきます。</p>
  ...
  <p class="caption">見分け方は「AWSのサービス名として聞いたことがあるか」。聞いたことのない名前が並んでいたら、残った1つが答えである可能性が高くなります。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②の「iSCSIで1本のディスクとして見せる」を実現できません。名前の時点で成立していません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「オンプレミスから使う」を満たしません。いちばん惜しく見える選択肢なので注意します。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③の「プライマリーストレージとして使う」＝毎日読み書きする、とは正反対の性格です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">オンプレから使えて（ヒント①）、iSCSIで1本のディスクに見えて（ヒント②）、本体をAWSに置ける（ヒント③）。3つすべてを満たします。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：D　AWS Storage GatewayをiSCSIデバイスとして利用する</strong></p>
    <p class="oboe">覚え方 —— <strong>「オンプレミス」と「AWSのストレージ」が同じ問題文に出たら AWS Storage Gateway。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>ステートレスな特性</td><td>途中経過をサーバーに溜めていない。どのインスタンスが担当してもよい</td></tr>
    <tr><td>②</td><td>途中で停止したり再開したりすることが容易</td><td><mark>急に中断されても困らない。これが決め手</mark></td></tr>
    <tr><td>③</td><td>処理時間は約1時間</td><td>ずっと動かし続けるわけではない</td></tr>
  </table>
  <p class="caption">「ステートレス」とは、作業の途中経過をそのサーバーの中に持たない作り方のことです。持っていないので、いつ止められても最初からやり直せます。</p>

  <h2>決め手は「中断されても平気かどうか」</h2>
  <p>スポットインスタンスは、AWSの<strong>空いているサーバーを格安で借りる</strong>仕組みです。オンデマンド料金の最大90%引きになります。ただし条件があり、AWS側でそのサーバーが必要になると、2分前の通知のあと取り上げられます。</p>
  ...
  <p class="caption">棒の長さが料金のイメージです。スポットが圧倒的に安いのは、中断されるという条件を引き受けているからです。</p>
  ...
  <p class="caption">問題文の「ステートレス」「停止・再開が容易」は、スポットインスタンスを選んでよいという許可証です。この言葉が出てきたら迷いません。</p>

  <p>たとえるなら、スポットインスタンスは劇場の当日キャンセル席です。空いていれば破格で観られますが、正規の予約客が来たら席を譲ることになります。何度でも観に来られる人なら、これが一番お得です。<strong>リザーブドは年間の指定席予約</strong>で、毎回必ず来る人向け。オンデマンドは当日の正規料金です。</p>
  ...
  <p class="caption">ベアメタルだけ料金体系ではなく、インスタンスの種類です。仮想化なしの物理サーバーがほしいときに選ぶもので、安さとは無関係です。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①とヒント②が「中断されても平気」と保証しているので、いちばん安いものを選べます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③のとおり、この処理は1時間で終わります。使っていない時間まで払い続けるので、コスト最適化にはなりません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">動きはしますが、中断されても平気なのに定価を払うことになります。問題はコスト最適化を求めているので負けます。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>「中断されても平気」「やり直せる」と書いてあればスポットインスタンス（最大90%引き）。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>サードパーティ製（別会社）のWEBアプリケーション</td><td>権限をあげる相手は自分のAWSアカウントの外にいる。アカウントをまたぐ話になる</td></tr>
    <tr><td>②</td><td>必要とする権限のみに限定</td><td>全部の権限を渡してはいけない。使う分だけに絞る（最小権限）</td></tr>
    <tr><td>③</td><td>第三者による不正利用を防ぐ</td><td><mark>渡した鍵が盗まれても被害が出ない仕組み</mark>でなければならない</td></tr>
  </table>
  ...
  <p>ホテルのルームキーを思い出してください。<strong>永久に使える金属の鍵を郵送する</strong>のと、チェックアウト時刻で自動的に無効になるカードキーをフロントで渡すのとでは、落としたときの怖さがまるで違います。IAMロールは後者です。</p>

  <h2>社外に渡してよいのは、期限つきのロールだけ</h2>
  <table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（相手はアカウントの外）、ヒント②（権限を絞る）、ヒント③（盗まれても期限切れになる）を全部満たします。これが正解です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">矢印の向きが逆です。今回必要なのは「外の業者が自社のEC2を呼ぶ」権限なので、ヒント①を満たしません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">求められていない部品を1つ増やすだけで、「業者だけに限定する」というヒント③の答えになっていません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③（盗まれても被害が出ない）に真正面から反します。SAAでは「外部に渡すIAMユーザー」はほぼ必ず不正解です。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A　権限を限定したIAMポリシーを設定したクロスアカウントアクセス用のIAMロールを作成し、外部WEBアプリケーションに設定する</strong></p>
    <p class="oboe">覚え方 —— <strong>「他社・別アカウントに権限を渡す」と書いてあれば、クロスアカウントのIAMロール。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>1秒間に3500件を超えるPUTリクエスト</td><td>S3の書き込み上限そのものの数字。3,500 PUT/秒はプレフィックス1つあたりの上限だと気づけるかが勝負</td></tr>
    <tr><td>②</td><td>迅速に処理するパフォーマンス</td><td>上限を超えるには、置き場所（プレフィックス）を分けて上限を足し算する</td></tr>
    <tr><td>③</td><td>最もファイル管理がしやすい方式</td><td><mark>速いだけではダメで、人間が後から探せること</mark>が条件に入っている</td></tr>
  </table>
  ...
  <h2>管理しやすさまで求められたら、日付のPrefix</h2>
  <table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">速さのヒント①・2は満たしますが、ヒント③の「最もファイル管理がしやすい」で負けます。名前から中身が分からないからです。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">問題文が言っているのは「1秒あたりのリクエスト件数」です。ファイル1個の大きさの話ではないので、ヒント①と噛み合いません。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>S3の上限はプレフィックスあたり毎秒3,500 PUT／5,500 GETなので、足りなければプレフィックスを分ける。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>初期段階では頻繁に利用される</td><td>最初の置き場所は取り出し料金がかからないS3 Standard。IAを選ぶと取り出すたびにお金を取られる</td></tr>
    <tr><td>②</td><td>4か月後にはほとんどアクセスされなくなる</td><td>4か月でルールを切り替える。ライフサイクルルールの出番</td></tr>
    <tr><td>③</td><td>アーカイブする／コストを最適化</td><td><mark>「アーカイブ」は倉庫の奥にしまう合図。いちばん安いクラスを選ぶ</mark></td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「初期段階では頻繁に利用される」に反します。移行先がInstant Retrievalなのもヒント③に対して割高です。二重に外しています。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（最初は頻繁）、ヒント②（4か月で切り替え）、ヒント③（アーカイブ＋最安）を全部満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">動きはしますが、問題文には「すぐ取り出したい」とは一言も書いてありません。要件にない速さにお金を払っているので、ヒント③のコスト最適化で負けます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p>移行先はいちばん安く、ヒント③には合っています。しかし最初の置き場所がIAのままです。</p>
      <p class="why">よく読む時期にIAを使うと取り出し料金がかさみ、かえって高くつきます。ヒント①を満たしません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　S3 Standardにデータを蓄積して、4カ月後にGlacier Deep Archiveに移行するライフサイクルルールを設定する</strong></p>
    <p class="oboe">覚え方 —— <strong>取り出しの速さを求められていない「アーカイブ」「コスト最適」は Glacier Deep Archive。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>AWS上でホストされているアプリケーション間の連携</td><td>呼ぶ側も呼ばれる側もAWSの中にいる。IAMで身元が分かる相手同士の話</td></tr>
    <tr><td>②</td><td>APIコール元に対して適切なアクセス権限を設定する</td><td><mark>「誰が、どのAPIを呼んでよいか」を書いたルールが要る</mark>。AWSでルールを書く道具はIAMポリシー</td></tr>
  </table>
  ...
  <table>
    ...
    <tr><td>AWS STS</td><td>一時的な入館証を発行する窓口。IAMロールを引き受けるときに裏で動いている</td><td>権限の中身を決めるのはあくまでIAMポリシー。STSは発券係であって規則ではない</td></tr>
    <tr><td>AWS Config</td><td>設定の変更履歴を記録し、ルール違反を見つける監査カメラ</td><td>アクセスを許可も拒否もしない。見て記録するだけ</td></tr>
    <tr><td>IAMアクセスキー</td><td>持ち主を証明するための鍵そのもの。期限がない</td><td>鍵は「本人かどうか」を示すだけ。「何をしてよいか」は決められない</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">STSが発行するのは期限つきの鍵であって、権限の中身ではありません。中身を決めるのはIAMポリシーなので、ヒント②に答えていません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（どちらもAWS内）とヒント②（誰が何を呼べるかのルール）の両方に答えています。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">記録するだけで、アクセスを許可も拒否もしません。そもそも権限を付与する機能がないので、ヒント②を満たしません。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>「誰が何をしてよいか」を決めるのは、AWSでは常にIAMポリシー。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>午前中はほとんど行われない／午後から増加</td><td>1日の中で使用量が大きく上下する。平らではない</td></tr>
    <tr><td>②</td><td>夕方には予測できないトラフィック</td><td><mark>どれだけ来るか前もって分からない。だから枠を決め打ちできない</mark></td></tr>
    <tr><td>③</td><td>短時間でトラフィックの急増</td><td>じわじわではなく一瞬で跳ね上がる。追いかける方式では間に合わない</td></tr>
  </table>
  ...
  <h2>読めない急増にはオンデマンド、一定ならプロビジョンド</h2>
  <table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">問題文には海外展開もリージョン障害対策も書かれていません。要件にない機能でコストを増やしているので、コスト最適化に反します。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②（予測できない）とヒント③（短時間の急増）にそのまま答えており、余計な機能も足していません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ただしAuto Scalingは混んできたと気づいてから広げる後追いです。ヒント③の「短時間の急増」には間に合わず、その数分間はエラーになります。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②にも3にも反し、さらにコストも増えます。すべての条件で負けています。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　オンデマンドモードのDynamoDBテーブルを作成する</strong></p>
    <p class="oboe">覚え方 —— <strong>DynamoDBのモードは、使用量が読めなければオンデマンド、読めればプロビジョンド。</strong></p>
  </div>`
  },
  {
    id: 'e1q26',
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>1つのAZがダウンし</td><td>持っている能力のうち、1AZ分がまるごと消える前提で計算する</td></tr>
    <tr><td>②</td><td>Auto Scalingが新たなインスタンスを起動できていない期間</td><td><mark>増やして助けてもらえない。今そこにある台数だけで耐えろ</mark>という条件</td></tr>
    <tr><td>③</td><td>常に100％のピークロードを処理できる</td><td>残ったAZの合計が100％以上でなければならない。99％では不合格</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②（増援なし）の条件のままヒント③（100％）を満たす、唯一の選択肢です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">1AZが落ちれば残り60％。ヒント③の100％にまったく届きません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">しかし1AZが落ちると50％に半減します。ヒント②により増援も呼べないので、ヒント③を満たせません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A　3つのAZに対して、AZ毎に50％のピークロードを処理できるAuto Scaling設定を行ったEC2インスタンスを展開する</strong></p>
    <p class="oboe">覚え方 —— <strong>「AZが1つ落ちても100％」なら、1AZあたりの割合は 100 ÷ （AZ数 − 1）。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>読み取り要求が増加している</td><td><mark>増えているのは読み取りだけ。書き込みは問題になっていない</mark></td></tr>
    <tr><td>②</td><td>データベース処理のパフォーマンスが低下</td><td>直したいのは速さ。壊れた話でも、止まった話でもない</td></tr>
    <tr><td>③</td><td>コスト最適に</td><td>読み取りだけを助ける、いちばん素直な方法を選ぶ</td></tr>
  </table>
  ...
  <h2>読み取りを増やすのはリードレプリカ。マルチAZは増やさない</h2>
  <table>
    ...
    <tr><td>マルチAZ配置</td><td>別のAZに待機用の複製を置き、障害時に自動で切り替える可用性の機能</td><td>待機側は普段まったく使われないので、読み取り性能は上がらない</td></tr>
    <tr><td>Amazon CloudFront</td><td>世界中の拠点に配置されたキャッシュ。ウェブの画像やHTMLを配るためのもの</td><td>データベースの前には置けない。SQLをキャッシュする仕組みではない</td></tr>
    <tr><td>Amazon DynamoDB</td><td>それ自体がNoSQLデータベース。キーで引く用途に強い</td><td>RDSのキャッシュとしては動かない。データベースのキャッシュ役はAmazon ElastiCache</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">データベースの前に置くという構成自体が成り立ちません。ヒント①の「読み取りの増加」に対する答えになっていません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">控えは普段はいっさい使われません。お金は2台分かかるのに読み取りは1台のままなので、ヒント②にもヒント③にも反します。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（読み取りだけが増えた）にぴったり対応し、必要なぶんだけ足せるのでヒント③のコスト最適も満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">さらにアプリ側にキャッシュの出し入れを全部作り込む必要があり、手間もコストも増えます。ヒント③に反します。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：C　Amazon RDS DBインスタンスに対してリードレプリカを増加させる</strong></p>
    <p class="oboe">覚え方 —— <strong>読み取りを増やすならリードレプリカ、止まりたくないならマルチAZ。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>コンサルティング会社のAWSアカウントと共有する</td><td>相手は1社だけ。<mark>全世界に公開してよいとは一言も書かれていない</mark></td></tr>
    <tr><td>②</td><td>KMSのカスタマー管理キーで暗号化されている</td><td>AMIを渡すだけでは中身が読めない。鍵を使う許可も別に要る</td></tr>
    <tr><td>③</td><td>移行作業のためにAMIを使う</td><td>相手はこのAMIからEC2を起動する。起動の許可（LaunchPermission）が必要</td></tr>
    </table>

  <h2>渡すものは「箱」と「鍵」の2つ</h2>
  <p>暗号化されたAMIは、<strong>南京錠のかかった箱</strong>だと思ってください。箱を相手の玄関先に置いただけでは中身は見えません。箱を渡す許可と、南京錠を開ける許可は別々に出す必要があります。</p>
  <div class="nodes v">
    <div class="node ok">
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①に反します。1社と共有すればよいところを全世界に開放しており、セキュリティ要件を満たしません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（1社限定）、ヒント②（復号の許可）、ヒント③（起動の許可）をすべて満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">すでに暗号化されたデータは、暗号化に使った元のキーでしか開けません。別の鍵をあとから許可しても南京錠は開かないので、ヒント②を満たせません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①にもヒント②にも反しており、しかも実際には動きません。二重に外れています。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>暗号化されたAMIを他アカウントへ渡すときは、AMIの共有とKMSキーの許可の2点セット。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>長時間にわたるDDoS攻撃</td><td>DDoS＝大量の通信を浴びせてサービスを止める攻撃。守る話であることは確定</td></tr>
    <tr><td>②</td><td>リクエストにかかるコストが増大した</td><td><mark>困っているのは「止まったこと」ではなく「請求額が増えたこと」</mark>。ここが本問の核心</td></tr>
    <tr><td>③</td><td>コスト増加を抑制する</td><td>攻撃で膨らんだ料金を肩代わりしてくれる仕組みが要る</td></tr>
  </table>
  ...
  <h2>攻撃中の請求が戻るのはShield Advancedだけ</h2>
  <table>
    <tr><th style="width:24%">名前</th><th style="width:34%">正体</th><th>できないこと</th></tr>
    <tr><td>AWS Shield Standard</td><td>全AWSユーザーに無料で自動的に有効化されている基本の防御。よくある種類の攻撃は自動で弾く</td><td>料金の払い戻しはない。すでに有効なので、これから適用する対策にもならない</td></tr>
    <tr><td class="good">AWS Shield Advanced</td><td class="good">有料の上位プラン。高度な攻撃の緩和に加え、DDoSコスト保護（攻撃で増えた料金のクレジット返還）と24時間の専門チーム支援がつく</td><td>月額の固定費がかかる。攻撃を受けていない平時にも費用が発生する</td></tr>
    <tr><td>Amazon GuardDuty</td><td>ログを機械学習で分析し、あやしい動きを見つけて知らせる見張り役</td><td>見つけて通知するだけ。通信を遮断しないし、料金も返らない</td></tr>
    <tr><td>AWSサポートのDDoS攻撃コストプラン</td><td>—</td><td>そんなサービスは存在しない。もっともらしい名前のダミー</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②とヒント③が求めている「料金が増えた」への直接の答えです。これが正解です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">気づかせてくれるだけで、攻撃を止めも料金を戻しもしません。ヒント③を満たしません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">今から適用するものではありませんし、料金の返還もありません。攻撃に耐えた結果として請求が増えたという、ヒント②の状況そのものを解決できません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　AWS Shield Advancedを適用する</strong></p>
    <p class="oboe">覚え方 —— <strong>「攻撃で料金が増えた」「返金」と書いてあれば AWS Shield Advanced。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>過去24時間以内の任意の時点に復元</td><td><mark>「任意の時点」は、決まった時刻のバックアップでは絶対に満たせない</mark>。14時37分に戻したいと言われたら困る</td></tr>
    <tr><td>②</td><td>運用上のオーバーヘッドを抑えつつ</td><td>スケジュールの管理も、古いバックアップの削除も、人がやらない方式を選ぶ</td></tr>
  </table>
  ...
  <h2>任意の時点に戻せるのはPITRだけ</h2>
  <table>
    <tr><th style="width:26%">名前</th><th style="width:34%">何をするものか</th><th>できないこと・向かないこと</th></tr>
    <tr><td class="good">ポイントインタイムリカバリ（PITR）</td><td class="good">スイッチ1つで有効化。直近35日間のどの秒にでも復元できる</td><td>35日より前には戻せない。長期保管には別途バックアップが要る</td></tr>
    <tr><td>オンデマンドバックアップ</td><td>ボタンを押したその瞬間の状態を、期限なく保存する</td><td>押した瞬間しか残らない。任意の時点には戻せず、押す運用も人の仕事になる</td></tr>
    <tr><td>AWS Backup</td><td>複数サービスのバックアップをまとめて管理する司令塔。保存期間のルールも一括で決められる</td><td>結局は決まった時刻のスナップショット。任意の時点には戻せず、プラン設計の手間も増える</td></tr>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（任意の時点）とヒント②（オーバーヘッド最小）の両方を、設定1つで満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">とはいえ残るのは決まった時刻のスナップショットです。ヒント①の「任意の時点」を満たせず、プランの設計という手間も増えます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">結果は定時のスナップショットにしかならずヒント①に反し、作り込みが増えるのでヒント②にも反します。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ボタンを押した瞬間しか残りません。24時間のどの時点にでも戻るには押し続けるしかなく、ヒント①にもヒント②にも反します。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A　DynamoDBテーブルに対してポイントインタイムリカバリを有効化する</strong></p>
    <p class="oboe">覚え方 —— <strong>「任意の時点に戻したい」と書いてあればPITR（DynamoDBは最大35日）。</strong></p>
  </div>`
  },
  {
    id: 'e1q31',
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">ポリシーの記述</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>"Effect": "Allow", "Action": "ec2:*"</td><td>1つ目のブロックで、EC2に関するすべての操作を許可している</td></tr>
    <tr><td>②</td><td>"Effect": "Deny"</td><td><mark>明示的なDenyは、どんなAllowよりも強い。必ず勝つ</mark>。IAMの絶対ルール</td></tr>
    <tr><td>③</td><td>"ec2:*ReservedInstances*" と "ec2:TerminateInstances"</td><td>拒否されるのは2種類。リザーブドインスタンス関連の操作と、インスタンスの終了</td></tr>
  </table>
  ...
  <p>これは<strong>校則と生徒手帳</strong>の関係に似ています。「校内の施設はすべて使ってよい（Allow）」と書いてあっても、別のページに「屋上は立ち入り禁止（Deny）」とあれば屋上には行けません。禁止のほうが必ず勝ちます。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②のとおりDenyが勝つので、リザーブドインスタンス関連の操作はむしろ禁止です。正反対の説明になっています。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">2つ目のDenyブロックを読み飛ばしています。ヒント③の2種類の操作は明確に拒否されているので、「全て許可」は成り立ちません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②とヒント③をそのまま読んだ結果です。これが正しい説明です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why"><code>ec2:TerminateInstances</code> は独立した項目で、リソースは <code>"*"</code>。限定されていないので「のみ」が誤りです。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：C　全てのEC2インスタンスを終了することができない</strong></p>
    <p class="oboe">覚え方 —— <strong>IAMポリシーは、明示的なDenyが1つでもあれば即アウト。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>ジョブを並列分散処理する／疎結合</td><td>ジョブをいったんためておく置き場が要る。処理する側が空いたら取りに行く形</td></tr>
    <tr><td>②</td><td>ジョブの負荷に応じてEC2インスタンス数が増減</td><td><mark>たまっているジョブの数を見て台数を決める</mark>。ここでどんな指標を使うかが本問の分かれ目</td></tr>
    <tr><td>③</td><td>ステートレス</td><td>どのインスタンスが処理しても同じ結果になる。だから台数を自由に増減してよい</td></tr>
  </table>
  ...
  <p class="caption">SNSは放送、SQSはレジの順番待ちの行列です。放送は一度流したら消えますが、行列に並んだ人は呼ばれるまでいなくなりません。しかもいま何人並んでいるかを数えられるので、そのまま「何台で処理すべきか」の判断材料になります。</p>

  <h2>3か所の選び分けが、そのまま答えになる</h2>
  <table>
    <tr><th style="width:24%">論点</th><th style="width:32%">正しいほう</th><th>もう一方ができないこと</th></tr>
    <tr><td>SQS か SNS か</td><td class="good">SQSキュー：ジョブをためて、空いた人が取りに行く</td><td>SNSは受け取った瞬間に全員へ配るだけ。ためられないので残件数を数えられない</td></tr>
    <tr><td>起動テンプレート か 起動設定 か</td><td class="good">起動テンプレート：現行の方式。バージョン管理ができ、新しい機能にも対応</td><td>起動設定は旧方式で、いったん作ると変更できず、AWSも新規利用を推奨していない</td></tr>
    <tr><td>バックログ／インスタンス か メッセージ総数 か</td><td class="good">インスタンスあたりのバックログ：残件数 ÷ 台数。1台の負担を一定に保つ</td><td>メッセージ総数は台数を考えない生の件数。1,000件という数字が「10台で足りている」のか「足りない」のか判断できない</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">SNSにはためる機能がないので、そもそも「キューメッセージ数」が存在しません。指標が取れず、ヒント①・ヒント②の両方が成り立ちません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">メッセージ総数は台数を考えない生の件数なので、台数が増えても指標は下がらず、増やし続けたり減らせなくなったりします。ヒント②の「負荷に応じて」を正しく満たせません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：C　Amazon SQSキューを作成し、起動テンプレートを使い、インスタンスあたりのバックログを指標にしたターゲット追跡スケーリングポリシーを設定したAuto Scalingグループを構成する</strong></p>
    <p class="oboe">覚え方 —— <strong>キュー連動のスケーリング指標は、必ずインスタンスあたりのバックログ（残件数 ÷ 台数）。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:38%">ポリシーの記述</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>"Effect": "Deny"</td><td>これは許可の文ではなく、禁止の文。「◯◯を拒否する」と読む</td></tr>
    <tr><td>②</td><td>"Condition": { "NotIpAddress": ... }</td><td><mark>Not がついている。「一致しないとき」に、この文が発動する</mark></td></tr>
    <tr><td>③</td><td>"aws:SourceIp": "54.240.143.0/24"</td><td>基準になるIPアドレスの範囲。54.240.143.0 から 54.240.143.255 までの256個</td></tr>
  </table>
  ...
  <h2>NotIpAddress ＋ Deny で「ここからだけ」になる</h2>
  <table>
    <tr><th style="width:30%">書き方</th><th style="width:34%">意味</th><th>結果</th></tr>
    <tr><td class="good">Deny ＋ NotIpAddress</td><td class="good">「その範囲以外から来たら拒否」</td><td class="good">指定範囲からだけ使える（今回のポリシー）</td></tr>
    <tr><td>Deny ＋ IpAddress</td><td>「その範囲から来たら拒否」</td><td>指定範囲だけを締め出す。正反対の意味になる</td></tr>
    <tr><td>Allow ＋ IpAddress</td><td>「その範囲から来たら許可」</td><td>似た結果になるが、他の場所からのDenyにはならない。別の場所に強いAllowがあれば通ってしまう</td></tr>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（EffectはDeny）を読み違えています。「このポリシーが何をしているか」の説明として誤りです。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①とヒント②の両方を逆に読んでいます。意味が正反対です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②のとおり、Denyが発動するのは「一致しないとき」です。指定範囲からのアクセスは、このポリシーでは拒否されません。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>「特定の場所からだけ許す」の定番は Deny ＋ NotIpAddress（Not付きは「〜でないとき」）。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>オンプレミスの複数の仮想マシン（VM）ごと移したい</td><td>ファイルのコピーではなく、サーバーまるごとを継続的に複製する必要がある</td></tr>
    <tr><td>②</td><td>目標復旧時間（RTO）を15分</td><td><mark>15分以内に立ち上がること。バックアップから作り直していては絶対に間に合わない</mark></td></tr>
    <tr><td>③</td><td>テストしてリカバリを検証できる</td><td>本番を止めずに「訓練」ができる仕組みであること</td></tr>
  </table>
  ...
  <h2>サーバーまるごと運べるのはElastic Disaster Recoveryだけ</h2>
  <table>
    ...
    <tr><td>AWS DataSync</td><td>オンプレとAWSの間でファイルやフォルダを高速に同期する引っ越し業者</td><td>サーバーまるごとは運べない。OSやアプリの状態は復元できない</td></tr>
    <tr><td>AWS Storage Gateway</td><td>オンプレから見るとローカルのディスクに見える、AWSにつながった共有フォルダ</td><td>同じくファイル単位。サーバーの起動可能なイメージにはならない</td></tr>
    <tr><td>AWS Backup</td><td>バックアップを一元管理する司令塔。定時に取って保管する</td><td>取り出して復元するのに時間がかかる。RTO 15分には届かない</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（VMまるごと）を満たさず、切り替え先を人手で作り込む必要があるためヒント②のRTO 15分にも届きません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（VMまるごと）、ヒント②（RTO 15分）、ヒント③（テストできる）をすべて満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">15分では終わりません。ヒント②に届かず、自動フェイルオーバーも成立しません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Elastic Disaster Recoveryが必要とするのはReplication Agentが送るブロック単位の複製であって、DataSyncのファイル同期ではありません。部品の組み合わせが成立していないので、ヒント①を満たせません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　AWS Replication Agentを使用してVMを増分的にAWSにレプリケートし、Elastic Disaster Recoveryでウォームスタンバイ構成を準備する</strong></p>
    <p class="oboe">覚え方 —— <strong>DRはRTOだけで決まり、数分〜数十分なら AWS Elastic Disaster Recovery。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>SQSキューはデフォルトの許可設定</td><td><mark>キュー側の設定はいじらない前提。だから許可を足す場所は「呼ぶ側」しかない</mark></td></tr>
    <tr><td>②</td><td>Lambda関数からSQSにメッセージを送信する</td><td>Lambdaが自分の身元を示して <code>sqs:SendMessage</code> を実行できる必要がある</td></tr>
  </table>
  ...
  <p class="caption">大事なのは、SQSアクセスポリシーはキューに付けるもので、Lambda関数には付けられないということです。</p>

  <h2>Lambdaに権限を与える先は、実行ロール</h2>
  <table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">付け先が違ううえ、ヒント①で「キューはデフォルトのまま」と指定されています。触ってはいけない場所を触っています。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">今回困っているのは「Lambdaが呼ばれる方法」ではなく「Lambdaが送る権限」です。ヒント②に答えていません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（キューは触らない）とヒント②（送る権限）の両方を満たす、唯一の選択肢です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">扱っているのは通信経路であって権限ではありません。SQSはVPCの外にあるので、そもそもこの設定では届きません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：C　適切なポリシーが付与されたIAMロールをLambda関数に設定して、Amazon SQSへのアクセスを許可する</strong></p>
    <p class="oboe">覚え方 —— <strong>「AWSのサービスAがBを呼ぶ権限」と書いてあれば、答えは常にIAMロール。</strong></p>
  </div>`
  },
  {
    id: 'e1q36',
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>膨大なクリックストリームをAPI経由で取り込んでデータ処理</td><td>受付はAPI Gateway＋Lambda。その先に、流れ続けるデータをためて処理する川が要る</td></tr>
    <tr><td>②</td><td>未加工のデータをS3バケットに保存する</td><td>川からS3へ流し込む配送係が別に要る。<mark>「ためて処理する」係と「届ける」係は別のサービス</mark></td></tr>
    <tr><td>③</td><td>データ内容に応じて分類した上で、一部をさらに分析</td><td>S3に置いたあと、中身を見て目録を作る係が要る</td></tr>
  </table>
  ...
  <table>
    ...
    <tr><td class="good">Amazon Data Firehose</td><td class="good">川からS3やRedshiftへ引く送水管。設定だけで動き、サーバー管理が不要</td><td>データをためない。あとから読み直せず、複数の処理に配れない</td></tr>
    <tr><td class="good">AWS Glue クローラー</td><td class="good">S3の中身を読んで、どんな列があるかの目録（データカタログ）を自動で作る司書</td><td>データそのものを検索したり集計したりはしない</td></tr>
    <tr><td>Amazon Athena</td><td>S3のデータにSQLを投げて集計・検索する分析ツール</td><td>データを分類したり目録を作ったりはしない。Glueが作った目録を使う側</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「API経由で取り込んでデータ処理」と、ヒント③の「一部をさらに分析」の両方に備える構成です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ためられないので、ヒント③の「一部のデータをさらに分析」に後から対応できません。川の代わりにはなりません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②の「未加工データをS3へ保存」を、いちばん手間をかけずに実現します。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Cとの違いは「川があるかどうか」です。川がないと、ヒント③に必要な読み直しができません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③の「データ内容に応じて保存データを分類する」に直接答えており、運用の手間も最小です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">そもそもAthenaが動くには、Glueが作った目録が先に必要です。順番が逆で、ヒント③の答えになっていません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A・C・E　API Gateway＋LambdaからKinesis Data Streamsへ送り、Data FirehoseでS3に保存し、AWS GlueクローラーでS3内のデータを分類する</strong></p>
    <p class="oboe">覚え方 —— <strong>「あとから読み直したい」「複数の処理に配りたい」ならData Streams、届けるだけならFirehose。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>認証情報を自動的にローテーションし</td><td><mark>パスワードを定期的に自動で作り直す機能が要る。ここが決め手</mark></td></tr>
    <tr><td>②</td><td>WEBサーバーからのデータベース接続を安全に保つ</td><td>EC2がパスワードを直接持たず、必要なときに取りに行く形にする</td></tr>
  </table>
  ...
  <p>これは<strong>ホテルのカードキー</strong>と同じ仕組みです。フロント（Secrets Manager）が定期的にカードを作り直し、同時に部屋のドア（RDS）の設定も書き換えます。宿泊客（EC2）は、使うたびにフロントで最新のカードを受け取ります。片方だけ書き換えたらドアは開かなくなるので、両方を同時に更新できることが重要です。</p>

  <h2>自動ローテーションがあるのはSecrets Managerだけ</h2>
  <table>
    <tr><th style="width:26%">名前</th><th style="width:34%">正体</th><th>できないこと</th></tr>
    <tr><td class="good">AWS Secrets Manager</td><td class="good">パスワードやAPIキー専用の金庫。RDS・Aurora・Redshiftなら、パスワードの自動ローテーションが標準機能</td><td>保管するシークレット1件ごとに月額がかかる（パラメータストアより高い）</td></tr>
    <tr><td>AWS Systems Manager パラメータストア</td><td>設定値を入れておく引き出し。暗号化もでき、基本の利用は無料</td><td>自動ローテーション機能がない。作り直しの処理を自分で書く必要がある</td></tr>
    <tr><td>AWS Systems Manager OpsCenter</td><td>運用中に起きた問題（OpsItem）を集めて管理する課題管理表</td><td>認証情報とは無関係。ここにアクセス許可を出しても何も解決しない</td></tr>
    <tr><td>「AWS Secrets Manager パラメーターストア」</td><td>—</td><td>そんなサービスは存在しない。2つのサービス名を混ぜたダミー</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（自動ローテーション）とヒント②（EC2が安全に取得）の両方を、追加の作り込みなしで満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①を満たせません。OpsCenterは運用課題の管理表であり、認証情報を読む場所ではないので、ヒント②にも答えていません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①を満たさず、ヒント②の経路も成立しません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A　ユーザー認証情報をAWS Secrets Managerのシークレットに保存し、IAMアクセス許可を付与してEC2インスタンスによるSecrets Managerへのアクセスを許可する</strong></p>
    <p class="oboe">覚え方 —— <strong>「自動ローテーション」の4文字が出たら、答えは問答無用で AWS Secrets Manager。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>現在は火曜日／今週末の72時間以内</td><td><mark>準備に使える時間は3日しかない。開通に何週間もかかる方法は選べない</mark></td></tr>
    <tr><td>②</td><td>データ容量は10TB</td><td>ネットワークで送れる量かどうかを計算して確かめる</td></tr>
    <tr><td>③</td><td>安全な通信を確保する／既にインターネットで接続済み</td><td>通信を暗号化する必要がある。回線そのものは既にある</td></tr>
  </table>

  <h2>まず、間に合うかどうかを計算する</h2>
  <p>10TBをビットに直すと、およそ<strong>80,000,000メガビット</strong>。72時間は259,200秒です。割り算すると、必要な速度はおよそ毎秒308メガビット（308Mbps）。AWSサイト間VPNのトンネル1本は最大1.25Gbps程度なので、十分に収まります。計算してみれば、ネットワーク転送で足りることが確認できます。</p>
  ...
  <p class="caption">新しい道を作るのではなく、いまある道に専用通路をかぶせるだけです。</p>
  <p>たとえるなら、VPNは公道にかぶせる屋根つきの専用通路です。道（インターネット回線）はもう通っているので、<strong>その上に中が見えない通路をかぶせるだけ</strong>。今日かぶせて今日から通れます。Direct Connectはこの専用通路を、公道とは別にゼロから敷くやり方なので、開通まで数週間から数か月かかります。</p>

  <h2>週末に間に合うのは、いまある回線を使う方法だけ</h2>
  <table>
    ...
    <tr><td>AWS Snowball Edge</td><td>発送・往復で約1週間</td><td>数十TB〜PB級、回線が細い、期限に余裕がある</td><td>物理的な配送が必要。72時間には絶対に間に合わない</td></tr>
    <tr><td>AWS Direct Connect</td><td>数週間〜数か月</td><td>長期にわたり安定した専用線が必要</td><td>物理回線の敷設工事が要る。週末には間に合わない</td></tr>
    <tr><td>AWS Storage Gateway</td><td>短い</td><td>オンプレから日常的にAWSのストレージを使い続ける</td><td>一括移行の道具ではない。使う経路は結局インターネットで、VPNのような暗号化トンネルを別に張るわけではない</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">申し込み・発送・データ書き込み・返送で1週間前後かかります。ヒント①の72時間に間に合いません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">開通まで数週間から数か月かかります。今日申し込んで週末に使うことはできず、ヒント①に反します。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（すぐ使える）、ヒント②（量が足りる）、ヒント③（暗号化される・回線は既にある）をすべて満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">一括移行のための道具ではありません。VPNのような暗号化トンネルを張るわけでもないので、ヒント③の「安全な通信の確保」に対する答えになっていません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：C　AWSサイト間VPNを利用したVPN接続によるデータ転送を実施する</strong></p>
    <p class="oboe">覚え方 —— <strong>移行は「容量 ÷ 期限」で必要な速度を出し、期限が数日ならSnowballとDirect Connectは脱落する。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>高い耐久性と可用性を持つストレージ</td><td>Amazon S3の標準クラスは耐久性99.999999999％（9が11個）。ファイル置き場として最強</td></tr>
    <tr><td>②</td><td>ファイルをアップロードして保存する</td><td>表形式のデータベースではなく、ファイルそのものを置く用途</td></tr>
    <tr><td>③</td><td>操作ミスで誤って削除されないように</td><td><mark>消したあとに元へ戻せる仕組みが要る。しかも「消した直後」でも戻せること</mark></td></tr>
  </table>
  ...
  <h2>S3にスナップショットはない。守りはバージョニング</h2>
  <table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（耐久性・可用性）、ヒント②（ファイル置き場）、ヒント③（誤削除からの復旧）をすべて満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">耐久性もS3に及ばず、定期スナップショットでは取った時刻より後に消したファイルは戻りません。ヒント①とヒント③の両方を満たせません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②に合いません。加えて、1件の削除ミスを直すためにデータベース全体を巻き戻すことになり、ヒント③への対応としても大がかりすぎます。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A　Amazon S3標準ストレージクラスを利用して、バージョニング機能を有効化する</strong></p>
    <p class="oboe">覚え方 —— <strong>S3の誤削除対策はバージョニング（S3にスナップショットという機能はない）。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>ACMからインポートされた証明書</td><td>外部で買った証明書を持ち込んだもの。ACMの自動更新が効かないので、期限切れを人が管理する必要がある</td></tr>
    <tr><td>②</td><td>有効期限の10日前</td><td><mark>「10日」という独自のしきい値。ACMが標準で出す通知のタイミングとは違う</mark></td></tr>
    <tr><td>③</td><td>独自のカスタムアラートを設定する</td><td>文面も自分たちで決めたい。判定と文面づくりをする場所が要る</td></tr>
  </table>
  ...
  <p class="caption">EventBridgeは合図を出すだけ、SNSは配るだけ。「10日以下か」を数えて文章を作る役は、間にいるLambdaしかいません。</p>
  <p>学校にたとえると分かりやすくなります。<strong>チャイム（EventBridge）は時間になれば鳴るだけ</strong>で、内容は判断しません。放送（SNS）は渡された原稿を読むだけです。「あと10日だから連絡しよう」と考えて原稿を書く先生（Lambda）が間に必要なのです。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Configの点検結果はそのままCloudWatchアラームで見張れる数値にはなりません。結局あいだをつなぐ処理を作ることになり、ヒント③のカスタム文面も別途必要です。遠回りです。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">10日という独自のしきい値を判定できず、ヒント②を満たせません。届くのも生のイベントデータなので、ヒント③の「カスタムアラート」にもなりません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②（独自のしきい値）とヒント③（独自の文面）を満たせる唯一の構成です。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：D　10日以内に期限が切れるACM証明書を検出するEventBridgeルールを作成し、AWS Lambda関数を呼び出して、Amazon SNSでカスタムアラートを通知する</strong></p>
    <p class="oboe">覚え方 —— <strong>「独自のしきい値」「カスタムメッセージ」と書いてあったら、EventBridgeとSNSの間にLambdaが要る。</strong></p>
  </div>`
  },
  {
    id: 'e1q41',
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>DBサーバーはWebサーバーからのトラフィックのみを受け入れる</td><td>許可する相手を絞る。セキュリティグループのインバウンドルールで指定する</td></tr>
    <tr><td>②</td><td>Auto Scalingグループを設定してインスタンスの数を増減</td><td><mark>Webサーバーは勝手に増えたり消えたりする。そのたびIPアドレスも変わる</mark></td></tr>
    <tr><td>③</td><td>異なるサブネットに配置</td><td>DBは外に出さないプライベートサブネット。パブリックIPは持たない</td></tr>
  </table>
  ...
  <p>社員食堂の入口を思い浮かべてください。<strong>「田中さんと佐藤さんを通す」と個人名で書く</strong>と、新入社員が入るたびに書き足さなければなりません。「社員証を持っている人を通す」と書けば、人が入れ替わっても張り紙はそのままです。セキュリティグループIDを指定するのは後者です。</p>
  ...
  <h2>作り直されても変わらないのはセキュリティグループID</h2>
  <table>
    ...
    <tr><td>プライベートIPアドレス</td><td>VPCの中だけで使われるアドレス。インスタンスごとに割り当てられる</td><td>インスタンスが作り直されると変わる。Auto Scalingとは相性が最悪</td></tr>
    <tr><td>パブリックIPアドレス</td><td>インターネットから見えるアドレス。停止・起動でも変わる</td><td>VPC内の通信では使われない。プライベートサブネットのDBには関係がない</td></tr>
    <tr><td>Elastic IPアドレス</td><td>固定できるパブリックIP。1つずつ手で割り当てる</td><td>Auto Scalingで増えるインスタンスに自動で付かない。そもそもWebサーバー群に固定IPを配る設計自体が現実的でない</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">しかしヒント②のとおり、Auto Scalingで生まれた新しいインスタンスは別のプライベートIPを持ちます。そのたびに拒否され、人がルールを追記することになります。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（Webからのみ許可）とヒント②（台数が変動する）の両方を、ルール1行で満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Auto Scalingで自動的に増えるインスタンスには付きません。ヒント②に真っ向から反します。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③のとおりDBはプライベートサブネットにいるため、そもそもこの経路で通信しません。加えて停止・起動のたびにアドレスが変わります。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　DBインスタンスのセキュリティグループのインバウンドルールにWEBサーバーインスタンスのセキュリティグループIDを設定する</strong></p>
    <p class="oboe">覚え方 —— <strong>AWSの中どうしの許可は、IPアドレスではなくセキュリティグループIDで指定する。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>他サイトからの直リンク（ホットリンク）</td><td><mark>問題は「誰が見ているか」ではなく「どのページから呼ばれたか」</mark>。ここが決め手</td></tr>
    <tr><td>②</td><td>URLリンクが無断で使用されている</td><td>URL自体は正しいものが使われている。URLを隠す方式では止まらない</td></tr>
    <tr><td>③</td><td>不正なリソース消費を防ぐ</td><td>他人のサイトの表示のために、こちらの通信料が使われている状態を止めたい</td></tr>
  </table>
  ...
  <p>これは<strong>よその店の看板に、こちらの電気を引き込んで灯している</strong>ようなものです。電気代を払っているのはこちらなのに、集客しているのは向こうの店です。Refererを見て「自社のページから呼ばれたときだけ配る」と決めれば止まります。</p>
  ...
  <h2>「どのページから来たか」を見られるのはWAFだけ</h2>
  <table>
    <tr><th style="width:26%">名前</th><th style="width:34%">何を判定するか</th><th>できないこと・向かないこと</th></tr>
    <tr><td class="good">AWS WAFのReferer制限</td><td class="good">どのページから呼ばれたかを見て通す・弾くを決める</td><td>Refererは偽装できるため完璧ではない。ただしホットリンク対策としては定番かつ十分</td></tr>
    <tr><td>署名付きURL</td><td>期限つきの特別なURLを作り、そのURLを持っている人だけに配る</td><td>今回は正規のURLが正しく使われているだけ。全訪問者ぶんのURLを毎回発行する仕組みが必要になり、公開コンテンツには重すぎる</td></tr>
    <tr><td>署名付きCookie</td><td>Cookieを配り、それを持っている人だけに複数ファイルをまとめて許可する</td><td>会員制サイトの配信向け。同じくどのページから来たかは判定できない</td></tr>
    <tr><td>S3アクセスの暗号化</td><td>保存時や通信時にデータを読めなくする</td><td>アクセスの可否とは無関係。暗号化しても正規のURLからは普通に配信される</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">今回は誰でも見てよい公開コンテンツで、困っているのは呼び出し元のページです。ヒント①に答えておらず、全訪問者にURLを発行する仕組みを新たに作る必要も出てきます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（どのページから呼ばれたか）を直接判定し、ヒント③（無駄な通信料）も発生前に止めます。通常の利用者には影響がありません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">判定するのは「Cookieを持っているか」であって「どこから来たか」ではありません。ヒント①を満たしません。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>「どのページから呼ばれたか」で止めたいなら AWS WAF のReferer条件。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>別の地域にあるデータセンターのスタンバイ環境</td><td><mark>復旧先は別リージョン。同じリージョン内の対策では要件を満たさない</mark></td></tr>
    <tr><td>②</td><td>切り替えを数分程度で実行可能に</td><td>バックアップから作り直す方式では絶対に間に合わない。常時複製が必要</td></tr>
    <tr><td>③</td><td>大量の読み取り処理が行われている</td><td>読み取りを分散できる構成だと、なおよい</td></tr>
  </table>
  ...
  <h2>リージョンをまたげるのはグローバルデータベースだけ</h2>
  <table>
    <tr><th style="width:26%">名前</th><th style="width:34%">どこまでカバーするか</th><th>できないこと</th></tr>
    <tr><td class="good">Auroraグローバルデータベース</td><td class="good">別リージョンへ常時複製。1秒未満の遅れで追随し、障害時は1分程度で昇格する</td><td>複製先リージョンぶんの費用がかかる（それでも常時2系統を動かすより安い）</td></tr>
    <tr><td>Auroraレプリカ</td><td>同じクラスター内、つまり同一リージョン内の別AZに読み取り用のコピーを置く</td><td>別リージョンには展開できない。リージョンごと落ちる災害には無力</td></tr>
    <tr><td>RDSマルチAZ配置</td><td>同一リージョン内の別AZに待機用を置く</td><td>同じくリージョンをまたげない。待機側は読み取りにも使えない</td></tr>
    <tr><td>mysqldumpによるバックアップ／復旧</td><td>全データを書き出して別環境に読み込む昔ながらの方式</td><td>データ量に比例して何時間もかかる。数分という要件には絶対に届かない</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①の「別の地域」をカバーできません。加えてmysqldumpによる復旧は何時間もかかるため、ヒント②の「数分」にも届きません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Auroraレプリカは同じクラスターの中、つまり同一リージョン内にしか置けません。別リージョンに広げるにはグローバルデータベースが必要です。構成として成立しておらず、ヒント①を満たせません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（別リージョン）、ヒント②（数分で切替）、ヒント③（読み取りの分散）をすべて満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p>リードレプリカを足したぶん、ヒント③の読み取り分散には対応できます。しかし災害復旧の中身はAと同じです。</p>
      <p class="why">mysqldumpによる復旧では数分に間に合わず、別リージョンへの常時複製にもなっていません。ヒント①とヒント②に反します。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：C　Amazon Aurora MySQLクラスターを本番用データベースとして構成し、Auroraグローバルデータベースを設定してAuroraレプリカを別リージョンに展開する</strong></p>
    <p class="oboe">覚え方 —— <strong>問題文に「別リージョン」が出たら、マルチAZと同一リージョンのレプリカは脱落する。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>アップグレード中は接続できない</td><td>データベースが一時的に不在になる時間がある。これ自体は避けられない</td></tr>
    <tr><td>②</td><td>その間に発生したデータは保存されない</td><td><mark>行き先が閉まっている間、データを預かっておく場所が要る</mark></td></tr>
    <tr><td>③</td><td>更新期間中のデータを保存する</td><td>失わないことが目的。速く書き込むことではない</td></tr>
  </table>
  ...
  <h2>DBが止まっている間、書き込みを預かれるのはSQS</h2>
  <table>
    <tr><th style="width:26%">名前</th><th style="width:34%">正体</th><th>できないこと・向かないこと</th></tr>
    ...
    <tr><td>Lambdaのローカルストレージ（/tmp）</td><td>実行中だけ使える一時的な作業場</td><td>実行が終われば中身は保証されない。あとから別の処理がスキャンすることもできない</td></tr>
    <tr><td>Lambdaの実行時間延長＋再試行</td><td>最長15分まで待たせて、失敗したら繰り返す</td><td>アップグレードが15分を超えたら全滅。その間ずっとLambdaが動き続けるので費用も無駄</td></tr>
    <tr><td>Amazon RDS Proxy</td><td>DBへの接続をまとめて再利用する接続の交通整理役。フェイルオーバーを速くする効果もある</td><td>データをためる機能はない。DBが長時間不在の間、書き込みを預かることはできない</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②の「預かっておく場所」になりません。別の実行環境から中身を読むこともできず、確実にデータが失われます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②（預ける場所）とヒント③（1件も失わない）を満たします。アップグレードが何時間かかっても耐えられます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Lambdaの上限は15分です。アップグレードが15分を超えた時点で、それ以降のデータはすべて失われます。待っている間ずっと課金され続けるのも無駄です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">解決するのは接続の本数であって、DBが長時間いないことではありません。データをためる機能がないので、ヒント②を満たせません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　Lambda関数が取得した顧客データをAmazon SQSキューに保存し、別のLambda関数がこのキューをポーリングしてAuroraデータベースに保存する</strong></p>
    <p class="oboe">覚え方 —— <strong>「送り先が止まっている間もデータを失いたくない」と書いてあれば、間にSQSを挟む。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>メッセージの順序が維持され</td><td>送った順番どおりに届くこと。標準の仕組みでは保証されない</td></tr>
    <tr><td>②</td><td>重複したメッセージが送信されない</td><td><mark>この2つが並んで出てきたら、AWSの答えは「FIFO」の一択</mark></td></tr>
  </table>
  ...
  <h2>順番を守れるのはFIFO。届け先はSQS FIFOに限られる</h2>
  <table>
    <tr><th style="width:26%">名前</th><th style="width:34%">正体</th><th>できないこと</th></tr>
    ...
    <tr><td>Amazon SES</td><td>メールを送受信するためのサービス</td><td>FIFOトピックという機能自体が存在しない。メッセージング基盤ではない</td></tr>
    <tr><td>AWS Lambda</td><td>短い処理を動かす場所</td><td>自分では順序を保証できない。届いたものを処理するだけで、並べ替えを自作すれば手間も増える</td></tr>
    <tr><td>AWS Step Functions</td><td>複数の処理を決めた順番で動かす指揮者。ワークフローの順序管理が役目</td><td>大量のメッセージを受け取って重複を排除する仕組みではない。用途が違う</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（順序）とヒント②（重複なし）を、設定ひとつで両方満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">同じくヒント①とヒント②を満たします。複数の処理へ同じ順序で配りたい場合の答えです。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">SESにFIFOトピックという機能は存在しません。実在しない選択肢です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">バラバラに届いたものを並べ替える処理を自分で書くことになり、重複排除も自作が必要です。ヒント①・2を仕組みとして保証できません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">管理するのは処理の順番であって、届くメッセージの順番ではありません。重複排除の機能もなく、ヒント②を満たせません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A・B　Amazon SQSのFIFOキューと、Amazon SNSのFIFOトピックを利用する</strong></p>
    <p class="oboe">覚え方 —— <strong>「順序を保証」「重複を排除」の2語が出たらFIFO（あるのはSQSとSNSだけ）。</strong></p>
  </div>`
  },
  {
    id: 'e1q46',
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>すべてのユーザーが変更または削除できない</td><td><mark>管理者もrootユーザーも例外なし。「偉い人なら消せる」方式では要件を満たさない</mark></td></tr>
    <tr><td>②</td><td>厳格なセキュリティ要件</td><td>あとから解除できる仕組みではダメ。一度決めたら覆せない設定を選ぶ</td></tr>
    <tr><td>③</td><td>アップロードされたドキュメント（ファイル）</td><td>置き場所はS3。ファイル単位で守る仕組みが要る</td></tr>
  </table>
  ...
  <p class="caption">ヒント①の「すべてのユーザー」という言葉が、そのままこの2つの分かれ目になります。</p>
  <p>これは<strong>試験の答案用紙を提出したあと</strong>と同じです。ガバナンスモードは「先生に頼めば書き直させてもらえる」状態、コンプライアンスモードは「提出した瞬間に封がされ、先生ですら開けられない」状態です。厳格さを求められているなら後者しかありません。</p>
  ...
  <p class="caption">順番が大事です。あとから普通のバケットにこの設定を足すことはできません。</p>

  <h2>誰にも消させないのはコンプライアンスモードだけ</h2>
  <table>
    <tr><th style="width:26%">名前</th><th style="width:34%">何ができるか</th><th>できないこと・問題点</th></tr>
    <tr><td class="good">S3オブジェクトロック コンプライアンスモード</td><td class="good">保持期間中はrootユーザーを含む誰も変更・削除できない。期間の短縮も不可</td><td>いったん設定すると取り消せない。期間を長く設定しすぎると保管料が膨らむ</td></tr>
    <tr><td>S3オブジェクトロック ガバナンスモード</td><td>通常のユーザーは変更・削除できない</td><td>特別な権限を持つ管理者は回避できる。「すべてのユーザー」という要件を満たさない</td></tr>
    <tr><td>Glacier ボールトロック</td><td>Glacierのボールト（保管庫）単位でポリシーを固定する古い仕組み</td><td>ファイル単位ではなく保管庫単位。さらにアーカイブへの移行という余計な手順が増える</td></tr>
    <tr><td>作成後にプロパティ画面で有効化</td><td>—</td><td>オブジェクトロックはバケット作成時にしか有効化できない。手順として成立しない</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（すべてのユーザー）、ヒント②（厳格）、ヒント③（ファイル単位）をすべて満たします。手順としても正しい順番です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">守る単位がファイルではなく保管庫で、アーカイブに移すという余計な手順も増えます。現在はオブジェクトロックが後継の仕組みなので、ヒント③に対して遠回りです。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">しかしヒント①は「すべてのユーザー」と書いています。特別な権限を持つ管理者が回避できる時点で、この要件を満たしません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">オブジェクトロックはバケットを作る時点でしか有効にできません。あとからプロパティ画面で足すことはできず、ヒント①・2の両方に反します。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：A　S3オブジェクトロックのコンプライアンスモードを有効にしたS3バケットを作成して、その中にドキュメントを保存する</strong></p>
    <p class="oboe">覚え方 —— <strong>「すべてのユーザー」「rootでも不可」ならコンプライアンスモード。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>プライマリおよびセカンダリの構成</td><td>本命と控えという主従関係がある。対等に分け合う構成ではない</td></tr>
    <tr><td>②</td><td>プライマリが障害を起こした際に備えて</td><td>健康状態を見て、ダメなら切り替える仕組みが要る</td></tr>
    <tr><td>③</td><td>セカンダリ構成は普段は利用されない</td><td><mark>平常時はセカンダリに1件も流してはいけない。ここが決め手</mark></td></tr>
    </table>
  ...
  <h2>普段使わない控えを持つのはフェイルオーバー</h2>
  <table>
    <tr><th style="width:26%">ルーティングポリシー</th><th style="width:34%">どう振り分けるか</th><th>できないこと・向かないこと</th></tr>
    <tr><td class="good">フェイルオーバー</td><td class="good">ヘルスチェックで主を監視し、異常時だけ控えに切り替える</td><td>平常時に負荷を分散する用途には使えない（今回はそれで正しい）</td></tr>
    <tr><td>加重（Weighted）</td><td>「9対1」のように割合を決めて分ける。カナリアリリースやA/Bテストに使う</td><td>平常時からセカンダリにも一定の割合が流れる。「普段は利用されない」に反する</td></tr>
    <tr><td>シンプル</td><td>1つのレコードに宛先を書くだけの基本形</td><td>ヘルスチェックによる切り替えができない。障害時も同じ宛先を返し続ける</td></tr>
    <tr><td>マルチバリュー回答</td><td>正常な宛先を最大8件まとめて返し、クライアントが選ぶ</td><td>主従関係がない。平常時からセカンダリも候補として返される</td></tr>
  </table>
  <p>参考までに、Route 53にはこのほか<strong>レイテンシー（応答が速いリージョンへ）</strong>、位置情報（アクセス元の国や地域で振り分け）もあります。どれも「主従」ではなく「使い分け」のための仕組みです。</p>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">割合をゼロにすればセカンダリに流れませんが、それでは障害時に切り替わりません。割合を持たせればヒント③に反します。どちらにしても要件を満たせません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヘルスチェックによる自動切り替えができません。プライマリが落ちても同じ宛先を返し続けるので、ヒント②を満たしません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">主従の関係を作れません。平常時からセカンダリも候補として返されるため、ヒント①とヒント③の両方に反します。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（主従）、ヒント②（障害時に切り替え）、ヒント③（平常時は使わない）をすべて満たします。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：D　ルーティングポリシーにフェイルオーバールーティングを設定する</strong></p>
    <p class="oboe">覚え方 —— <strong>「普段は利用されない」という一文が出たら、フェイルオーバー以外は消える。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>5年間保存する／大部分はあまりアクセスされない</td><td>長期保管が目的。読み出す前提で置く場所ではない</td></tr>
    <tr><td>②</td><td>24時間以内にデータを提供する</td><td><mark>24時間も待てる。即座に読める必要はまったくない</mark>。ここが決め手</td></tr>
    <tr><td>③</td><td>コスト効率の良いストレージ</td><td>24時間という条件を満たす中で、いちばん安いものを選ぶ</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">24時間も待てるのに、3〜5時間という速さにDeep Archiveの約3.6倍を払うことになります。ヒント②とヒント③を組み合わせると負けます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント①（長期保管）、ヒント②（24時間でよい）、ヒント③（最安）をすべて満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ほとんど読まないデータを5年間置くには高すぎます。Deep Archiveのおよそ23倍で、ヒント③に大きく反します。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">Deep Archiveより10倍高いうえ、そのAZが失われるとデータも失われます。法令で5年保存する記録には使えません。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ここでも即時性は求められていません。要件にない速さにDeep Archiveの約13倍を払うことになり、ヒント③に反します。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　Amazon S3 Glacier Deep Archive</strong></p>
    <p class="oboe">覚え方 —— <strong>アーカイブは待てる時間で決まり、「24時間以内」「翌日まで」はDeep Archive（約12時間）。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>単一のEC2インスタンスに、ウェブもMySQLも同居している</td><td><mark>この1台が止まればすべてが止まる。Webとデータベースを分けるところから始まる</mark></td></tr>
    <tr><td>②</td><td>スケーラブルで高可用性なアーキテクチャに再構成</td><td>台数を増やせること、1か所が落ちても動くこと。AZをまたぐ構成にする</td></tr>
    <tr><td>③</td><td>MySQLの読み取りレイテンシーも削減</td><td>読み取り専用のコピーを用意して、読み取りを分ける</td></tr>
    </table>
  ...
  <p class="caption">柱（サーバー）を増やし、しかも別々の基礎（アベイラビリティーゾーン）の上に立てるイメージです。同じ基礎に全部載せていたら、その基礎が沈んだときに建物ごと倒れます。</p>
  ...
  <table>
    ...
    <tr><td>Auroraグローバルデータベース</td><td>別リージョンへ複製する。リージョン規模の災害に備える機能</td><td>問題文に別リージョンの要件はない。要件にない機能でコストだけが増える</td></tr>
    <tr><td>別リージョンにEC2 ＋ Route 53フェイルオーバー</td><td>リージョン障害時に別リージョンへ切り替える</td><td>スケーラビリティにならない。台数は増えず、控えは普段使われないまま費用だけかかる</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②の「スケーラブル」と「高可用性」の両方を、Web層について満たします。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">EC2は結局1台ずつなのでスケーラブルになりません。ヒント②の「台数を増やせること」を満たさず、待機分のコストだけが増えます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">問題文には別リージョンの要件が一切ありません。要件にない機能でコストを増やしているので、過剰な構成です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント③（読み取りレイテンシーの削減）とヒント②（高可用性）を、1つの構成で同時に満たします。</p>
    </div>
  </div>
  ...
  <div class="kotae">
    ...
    <p class="oboe">覚え方 —— <strong>問題文に「別リージョン」がなければ、グローバルデータベースは過剰構成として切る。</strong></p>
  </div>`
  },
  ...
  <table>
    <tr><th style="width:2.2em">#</th><th style="width:34%">問題文のことば</th><th>ここから分かること</th></tr>
    <tr><td>①</td><td>通常はほとんど使用されない</td><td>ふだんは眠らせておくデータ。Glacierが適している</td></tr>
    <tr><td>②</td><td>10時間以内にデータを取得する</td><td><mark>10時間は必ず守る線。1分でも超える可能性がある方式は選べない</mark></td></tr>
    <tr><td>③</td><td>コスト最適な設定</td><td>10時間を確実に守れる中で、いちばん安いものを選ぶ</td></tr>
    </table>
  ...
  <p class="caption">大容量取り出しは安いのですが、上限が12時間。10時間を超える可能性があるので選べません。</p>
  ...
  <p>宅配便にたとえると分かりやすくなります。<strong>翌朝10時までに必ず届けたい</strong>とき、「5〜12時間で届きます」という一番安い便は選べません。多少高くても「3〜5時間で確実に届く」便を選ぶのが正しい判断です。</p>

  <h2>取り出しは「締め切りに間に合う中で一番安いもの」</h2>
  <table>
    <tr><th style="width:24%">名前</th><th style="width:24%">かかる時間</th><th style="width:18%">料金</th><th>向かないこと</th></tr>
    <tr><td>迅速取り出し（Expedited）</td><td>1〜5分</td><td>最も高い</td><td>10時間も余裕があるのに、分単位の速さに払っている</td></tr>
    <tr><td class="good">標準取り出し（Standard）</td><td class="good">3〜5時間</td><td class="good">中間</td><td>数分で欲しい緊急時には遅い</td></tr>
    <tr><td>大容量取り出し（Bulk）</td><td>5〜12時間</td><td>最も安い（無料の場合もある）</td><td>12時間かかる可能性がある。10時間という締め切りを守れない</td></tr>
    <tr><td>ボールトロック</td><td>—</td><td>—</td><td>そもそも取り出しオプションではない。保管庫のポリシーを固定して変更できなくする機能</td></tr>
  </table>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">10時間も待てるのに分単位の速さを買っています。ヒント③のコスト最適に反します。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">ヒント②（10時間以内を必ず守る）を満たしたうえで、迅速取り出しより大幅に安い。ヒント③も満たす唯一の選択肢です。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">かかる時間が5〜12時間です。12時間かかれば10時間を超えるので、ヒント②を確実には満たせません。安さよりも締め切りが優先されます。</p>
    </div>
  </div>
  ...
  <div class="choice">
    ...
    <div>
      ...
      <p class="why">取り出しの速さを決める設定ではありません。ヒント②にもヒント③にも答えていません。</p>
    </div>
  </div>

  <div class="kotae">
    <p><strong>答え：B　標準取り出し</strong></p>
    <p class="oboe">覚え方 —— <strong>取り出しは、制限時間に最悪の所要時間が収まるものの中からいちばん安いものを選ぶ。</strong></p>
  </div>`
  },
  ],
};
