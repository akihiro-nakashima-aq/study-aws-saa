...
const EXAM = {
  ...
  <p>たとえるなら、<mark>VPNは公道にかぶせる屋根つきの専用通路</mark>です。道（インターネット回線）はもう通っているので、<strong>その上に中が見えない通路をかぶせるだけ</strong>。今日かぶせて今日から通れます。Direct Connectは<strong>この専用通路を、公道とは別にゼロから敷く</strong>やり方なので、開通まで数週間から数か月かかります。</p>
  ...
  <p class="caption">柱（サーバー）を増やし、しかも<strong>別々の基礎（アベイラビリティーゾーン）の上に立てる</strong>イメージです。同じ基礎に全部載せていたら、その基礎が沈んだときに建物ごと倒れます。</p>
